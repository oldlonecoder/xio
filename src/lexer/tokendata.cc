...
static token_data::collection tokens_table =
{
    ...
    {mnemonic::Number,              type::Prefix,    type::Number|type::Unary|type::Keyword|type::Prefix|type::Operator     ,type::distance::identifier, lexem::Number, 1},
    {mnemonic::U8,                  type::Prefix,    type::U8|type::Keyword|type::Prefix|type::Operator         ,type::distance::identifier, lexem::U8,     1},
    {mnemonic::U16,                 type::Prefix,    type::U16|type::Unary|type::Keyword|type::Prefix|type::Operator        ,type::distance::identifier, lexem::U16,    1},
    {mnemonic::U32,                 type::Prefix,    type::U32|type::Unary|type::Keyword|type::Prefix|type::Operator        ,type::distance::identifier, lexem::U32,    1},
    {mnemonic::U64,                 type::Prefix,    type::U64|type::Unary|type::Keyword|type::Prefix|type::Operator        ,type::distance::identifier, lexem::U64,     1},
    {mnemonic::I8,                  type::Prefix,    type::I8|type::Unary|type::Keyword|type::Prefix|type::Operator         ,type::distance::identifier, lexem::I8,      1},
    {mnemonic::I16,                 type::Prefix,    type::I16|type::Unary|type::Keyword|type::Prefix|type::Operator        ,type::distance::identifier, lexem::I16,     1},
    {mnemonic::I32,                 type::Prefix,    type::I32|type::Unary|type::Keyword|type::Prefix|type::Operator        ,type::distance::identifier, lexem::I32,     1},
    {mnemonic::I64,                 type::Prefix,    type::I64|type::Unary|type::Keyword|type::Prefix|type::Operator        ,type::distance::identifier, lexem::I64,     1},
    {mnemonic::Float,               type::Prefix,    type::Float|type::Unary|type::Keyword|type::Prefix|type::Operator      ,type::distance::identifier, lexem::Float,   1},
    {mnemonic::String,              type::Prefix,    type::Text|type::Unary|type::Keyword|type::Prefix|type::Operator       ,type::distance::identifier, lexem::String,  1},
    ...
    {mnemonic::LowHex,              type::Prefix,    type::Unary|type::Prefix|type::Leaf|type::Keyword|type::Operator|type::Hex  ,type::distance::noop_,      lexem::LowHex,     1},
    {mnemonic::UpHex,               type::Prefix,    type::Unary|type::Prefix|type::Leaf|type::Keyword|type::Operator|type::Hex  ,type::distance::noop_,      lexem::UpHex,      1},
